...
\section{Technical Skills}
  \headstart
    ...
    \itemdesc{Tools}{
      ...
      Selenium, BeautifulSoup, Web3.py, Gcloud SDK, Docker, Git, Bash
    }
  \headend
  ...
  {CyphaLab}{Remote}
    \roletimehead
      ...
      \itemstart
        ...
        \listitem{
          Achieved an annual Sharpe ratio of 3.49 and an annual Calmar ratio of 7.2 since
          inception.
        }
      \itemend
    \roletimehead
...
\titleplacehead
  {HKUST School of Engineering}{Remote}
  ...
  \titleplacehead
  {Kook Surf Inc.}{San Diego, CA}
    \roletimehead
      {Founder}{December 2021 - August 2022}
      \itemstart
        \listitem{
          Founded an IoT surfboard rentals company using automated rental stations powered by
          Arduino and NFC.
        }
        \listitem{
          Co-developed the mobile app for the company using React Native and Flask.
        }
        \listitem{
          Developed and tested the embedded system for the rental stations, ensuring reliability and
          security of the transactions.
        }
        \listitem{
          Successfully sold the company after validating the market demand by generating over \$10,000
          revenue.
        }
      \itemend
  ...
  \titleplacehead
  {VotingDAO (votingdao.io)}{Remote}
    \roletimehead
      {Co-Founder}{December 2021 - March 2022}
      \itemstart
        \listitem{
          Founded and led VotingDAO, a decentralized organization that aims to empower the
          blockchain community through fair and transparent voting mechanisms.
        }
        \listitem{
          Organized the Blockchain Person Of The Year 2021 Election on Ethereum, Polygon and BNB
          Chain, attracting over 15,000 participants and generating significant media attention and
          social impact.
        }
        \listitem{
          Partnered with and endorsed by industry leaders such as BAYC, Animoca Brands, Polygon DAO,
          Consensys, etc., establishing strong relationships and collaborations within the
