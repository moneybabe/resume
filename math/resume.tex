  ...
  \headstart
    ...
    {UC Berkeley Department of Mathematics}{Berkeley, CA}
      \roletimehead
        ...
        \itemstart
          \listitem{
            Built a finite integer line tug-of-war game simulator with \textbf{Python, Numpy, and Pandas} to 
            solve for Markov perfect equilibria with dynamic programming, and visualized the 
            results with \textbf{Matplotlib}.
          }
          \listitem{
      ...
      \roletimehead
        ...
        \itemstart
          \listitem{
            ...
            using \textbf{Pytorch, Sklearn, and Seaborn}, achieving MSE of 1.8 compared to a simple linear 
          ...
          \listitem{
            Built an Alpha-beta pruning algorithm \& NN based chess engine with \textbf{C++} to 
